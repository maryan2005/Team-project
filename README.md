...
Our team is developing a Tetris game using Python and the Pygame library. The goal is to create a playable game where users move, rotate, and drop different Tetris blocks onto a board.

The game will include features such as block movement, rotation, line clearing, scoring, and game-over detection. We will use software engineering principles from ASE 420 to improve the code structure, reduce global variables, and make the project easier to understand and maintain.

Our team has three members. Each member will be responsible for 8 assigned tasks. We will work together to combine our code, test the game, and complete the project.
